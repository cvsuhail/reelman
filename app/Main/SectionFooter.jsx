    ...
    <section className="footer">
      <div className="footer-content">
        <div className="footer-content-left" ref={topRef1} >
          ...
          <h1 className="subheadline white" >ReelMan Uniforms</h1>
          <p className="description grey"  >Premium uniform solutions in Abu Dhabi. Delivering exceptional quality workwear and professional attire across the UAE.</p>
        </div>
      ...
      <div className="footer-content-bottom">
        <p className="small-description grey" ref={bottomRef1} >© 2024 ReelMan Uniforms All Rights Reserved</p>
