...
// import { NeedleAndThread } from "./HeroModel/Clothing";
import { SphereModel } from "./HeroModel/SphereModel";
  ...
  return (
    <section className="hero">
            ...
            <div className="hero-buttons-row">
              <button className="button button-transparent-border opacity-blur" ref={buttonRef1} >
                <div className="button-content">
                  <span className="small-description">Our Services</span>
                  <span className="small-description">Our Services</span>
                </div>
      ...
      <div className="hover-cursor" ref={cursor}>
        <p className="small-description white" >Explore</p>
      </div>
    </section>
  );
};