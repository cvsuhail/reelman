        ...
        <div className="contact-content">
          <div className="contact-content-top">
            <div className="titlebox">
              ...
              <h1 className="headline white" ref={titleRef} >Contact ReelMan Uniforms</h1>
            </div>
            ...
            <div className="contact-content-left">
              <div className="contact-content-column">
                ...
                <div className="contact-content-item opacity-blur" ref={contactItem5} >
                  ...
                  <p className="description white" >Schedule consultation</p>
                </div>
                <div className="contact-content-item opacity-blur" ref={contactItem6} >
                  <p className="small-description grey" >Email</p>
                  <p className="description white" >info@reelmanuniforms.ae</p>
                </div>
                <div className="contact-content-item opacity-blur" ref={contactItem7} >
                  <p className="small-description grey" >Address</p>
                  <p className="description white" >Abu Dhabi</p>
                  <p className="description white" >UAE</p>
                  <p className="description white" >Business Hours: Sat-Thu 9AM-6PM</p>
                </div>
              </div>
            </div>
            <div className="contact-content-right opacity-blur" ref={imageWrapperRef} >
              <img src="/images/logo.png" className="contact-content-right-image" ref={imageRef} alt="" />
            </div>
          </div>
        </div>
      </section>
