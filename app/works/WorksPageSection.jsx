        ...
        <div className="works-content" >
            ...
            <div className="works-content-top-text">
              <div className="works-content-textbox">
                <div className="titlebox">
                  ...
                  <h1 className="headline white" ref={titleRef} >Our Uniform Solutions</h1>
                </div>
                <p className="description grey opacity-blur" ref={descriptionRef} >Explore our comprehensive range of uniform solutions designed for various industries across Abu Dhabi and the UAE.</p>
              </div>
              ...
              <div className="works-carousel" ref={emblaRef2} >
                <div className="works-carousel-row">
                  ...
                  <div className="works-item" >
                    <div className="works-item-content" >
                      <div className="works-item-content-textbox">
                        <h2 className="subheadline white" >Corporate Uniforms</h2>
                        <div className="works-item-content-textbox-row">
                          <div className="works-item-content-textbox-button">
                            <p className="small-description white" >Business Attire</p>
                          </div>
                          <div className="works-item-content-textbox-button">
                            <p className="small-description white" >Custom Tailoring</p>
                          </div>
                        </div>
                      </div>
                  ...
                  <div className="works-item" >
                    <div className="works-item-content" >
                      <div className="works-item-content-textbox">
                        <h2 className="subheadline white" >Healthcare Uniforms</h2>
                        <div className="works-item-content-textbox-row">
                          <div className="works-item-content-textbox-button">
                            <p className="small-description white" >Medical Scrubs</p>
                          </div>
                          <div className="works-item-content-textbox-button">
                            <p className="small-description white" >Lab Coats</p>
                          </div>
                        </div>
                      </div>
                  ...
                  <div className="works-item" >
                    <div className="works-item-content" >
                      <div className="works-item-content-textbox">
                        <h2 className="subheadline white" >School Uniforms</h2>
                        <div className="works-item-content-textbox-row">
                          <div className="works-item-content-textbox-button">
                            <p className="small-description white" >Student Attire</p>
                          </div>
                          <div className="works-item-content-textbox-button">
                            <p className="small-description white" >PE Kits</p>
                          </div>
                        </div>
                      </div>
                  ...
                  <div className="works-item" >
                    <div className="works-item-content" >
                      <div className="works-item-content-textbox">
                        <h2 className="subheadline white" >Hospitality Uniforms</h2>
                        <div className="works-item-content-textbox-row">
                          <div className="works-item-content-textbox-button">
                            <p className="small-description white" >Hotel Staff</p>
                          </div>
                          <div className="works-item-content-textbox-button">
                            <p className="small-description white" >Restaurant Staff</p>
                          </div>
                        </div>
                      </div>
                  ...
                  <div className="works-item" >
                    <div className="works-item-content" >
                      <div className="works-item-content-textbox">
                        <h2 className="subheadline white" >Security Uniforms</h2>
                        <div className="works-item-content-textbox-row">
                          <div className="works-item-content-textbox-button">
                            <p className="small-description white" >Guard Attire</p>
                          </div>
                          <div className="works-item-content-textbox-button">
                            <p className="small-description white" >Tactical Gear</p>
                          </div>
                        </div>
                      </div>
                  ...
                  <div className="works-item" >
                    <div className="works-item-content" >
                      <div className="works-item-content-textbox">
                        <h2 className="subheadline white" >Industrial Workwear</h2>
                        <div className="works-item-content-textbox-row">
                          <div className="works-item-content-textbox-button">
                            <p className="small-description white" >Safety Gear</p>
                          </div>
                          <div className="works-item-content-textbox-button">
                            <p className="small-description white" >Construction Wear</p>
                          </div>
                        </div>
                      </div>
                  ...
                  <div className="works-item" >
                    <div className="works-item-last-content" >
                      <p className="description white" >Be our next uniform client!</p>
                      <h2 className="subheadline white" >Let us design your uniforms.</h2>
                      <div className="contact-button-wrapper">
                        <button className="contact-button-white" >
                          ...
                          <span className="description black" >Get Quote</span>
                        </button>
                      </div>
                    </div>
                    <div className="works-item-border" />
          ...
          <div className="works-industries">
            <div className="works-subtextbox">
              ...
              <p className="description grey" ref={subdescriptionRef1} >Our uniform specialists have served businesses across various sectors. They understand industry requirements and deliver solutions that enhance professionalism and brand image.</p>
            </div>
                  ...
                  <div className="casestudies-item" >
                    <div className="casestudies-item-content">
                      <div className="casestudies-item-content-textbox">
                        <div className="subheadline-box" >
                          <Zap className="subheadline-box-icon" />
                          <h2 className="small-description grey" >Healthcare</h2>
                        </div>
                        <h3 className="small-subheadline white" >Medical Center Transformation</h3>
                        <p className="description grey" >Creating comfortable, professional medical uniforms for a major Abu Dhabi healthcare facility.</p>
                      </div>
                      <div className="casestudies-item-content-imagebox" >
                        <div className="button casestudies-item-content-imagebox-button">
                          <div className="button-content">
                  ...
                  <div className="casestudies-item" >
                    <div className="casestudies-item-content">
                      <div className="casestudies-item-content-textbox">
                        <div className="subheadline-box" >
                          <Zap className="subheadline-box-icon" />
                          <h2 className="small-description grey" >Hospitality</h2>
                        </div>
                        <h3 className="small-subheadline white" >Luxury Hotel Uniforms</h3>
                        <p className="description grey" >Creating elegant uniforms for a 5-star hotel chain across the UAE, enhancing guest experience.</p>
                      </div>
                      <div className="casestudies-item-content-imagebox" >
                        <div className="button casestudies-item-content-imagebox-button">
                          <div className="button-content">
